		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								com.Dinghaoyuan.model.Product p = (com.Dinghaoyuan.model.Product)pageContext.findAttribute("p");
								int pid = p.getProductID();
								java.sql.Connection con = (java.sql.Connection)application.getAttribute("con");
								String catName = com.Dinghaoyuan.model.Category.findByCategoryId(con,pid);
							%>
