...
import com.Dinghaoyuan.model.Payment;
...
public class OrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int customerId=request.getParameter("customerId")!=null?Integer.parseInt(request.getParameter("cutomerId")):0;
        int paymentId = request.getParameter("customerId")!=null?Integer.parseInt(request.getParameter("customerId")):0;
        ...
        address1==null||address1.trim().length()==0||postalCode.trim().length()==0){
            message="Error";
